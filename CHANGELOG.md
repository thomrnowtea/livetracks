...
- Fused the redundant landscape metronome scope/source hierarchy into Template, Inherits, and Custom states, then placed tempo, meter, click level, and MAIN audition in one fully visible console rack above transport.
